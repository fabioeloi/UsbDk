...
description: >
  ...
  on ARM (ARM64). Audits build system files, patches architecture-specific
  source code, updates INF metadata, adds ARM64 CI jobs, and opens a draft PR —
  without breaking existing x64 builds.
tools:
  - read
  - edit
  - search
...
deployment; test-signing mode is sufficient for development.Describe what your agent does here...
